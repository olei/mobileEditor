...
RE.setBold = function() {
    if (RE.isCommandEnabled('bold')) {
        ...
        if (selectedText.length > 0) {
            document.execCommand('insertHTML', false, selectedText + '&zwnj;');
        } else {
...
RE.insertImage = function(url, alt,id) {
    ...
    RE.insertHTML('<p><br></p><p>' + span.outerHTML + '</p><p data-type="imgBoxNextBox" class="imgDes">图片发自家长帮APP</p><p><br></p>', span.id);
...
RE.titleEditor.addEventListener("paste", function(e) {
